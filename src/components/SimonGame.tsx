...
export function SimonGame({ position, zoneSize }: SimonGameProps) {
  ...
  }, [simonPattern, setSimonLitButton, setSimonShowingPattern, setSimonCanClick]);
  ...
  }, [camera, position, isNearSimon, isSimonActive, isLocked, keys, resetInteract, setIsNearSimon, setIsSimonActive, handleExitGame]);
  ...
  useEffect(() => {
    ...
    const startTimer = setTimeout(showNextPatternButton, SIMON_CONFIG.GAME.PATTERN_DELAY);
  ...
  }, [simonIsShowingPattern, simonPattern, showNextPatternButton]);
